...
impl EndParagraphRunProperties {
    ...
    pub fn set_text<S: Into<String>>(&mut self, value:S) -> &mut EndParagraphRunProperties {
    ...
    pub fn set_kumimoji<S: Into<String>>(&mut self, value:S) -> &mut EndParagraphRunProperties {
    ...
    pub fn set_lang<S: Into<String>>(&mut self, value:S) -> &mut EndParagraphRunProperties {
    ...
    pub fn set_alt_lang<S: Into<String>>(&mut self, value:S) -> &mut EndParagraphRunProperties {
    ...
    pub fn set_sz<S: Into<String>>(&mut self, value:S) -> &mut EndParagraphRunProperties {
    ...
    pub fn set_solid_fill(&mut self, value:SolidFill) -> &mut EndParagraphRunProperties {
