...
impl RadarChart {
    ...
    pub fn set_area_chart_series(&mut self, value:Vec<AreaChartSeries>)-> &mut RadarChart {
        self.area_chart_series = value;
        self
    }

    pub fn add_area_chart_series(&mut self, value:AreaChartSeries)-> &mut RadarChart {
