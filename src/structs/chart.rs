...
impl Chart {
    ...
    pub(crate) fn new_chart_line_chart(
        &mut self, 
        area_chart_series_list: Vec<&str>,
    ) {
        ...
        for area_chart_series in area_chart_series_list {
            ...
            values.get_number_reference_mut().get_formula_mut().get_address_mut().set_address(area_chart_series);
            values.get_number_reference_mut().get_numbering_cache_mut().get_format_code_mut().set_text("General");
        ...
        graphic_frame.get_graphic_mut().get_graphic_data_mut().get_chart_space_mut().get_editing_language_mut().set_val(&self.default_language);
        graphic_frame.get_graphic_mut().get_graphic_data_mut().get_chart_space_mut().get_chart_mut().get_plot_area_mut().set_line_chart(line_chart);
        graphic_frame.get_graphic_mut().get_graphic_data_mut().get_chart_space_mut().get_chart_mut().get_plot_area_mut().add_category_axis(category_axis);
        graphic_frame.get_graphic_mut().get_graphic_data_mut().get_chart_space_mut().get_chart_mut().get_plot_area_mut().add_value_axis(value_axis);
        graphic_frame.get_graphic_mut().get_graphic_data_mut().get_chart_space_mut().get_chart_mut().get_legend_mut().get_legend_position_mut().set_val(LegendPositionValues::Right);
        graphic_frame.get_graphic_mut().get_graphic_data_mut().get_chart_space_mut().get_chart_mut().get_legend_mut().set_layout(layout);
        graphic_frame.get_graphic_mut().get_graphic_data_mut().get_chart_space_mut().get_chart_mut().get_plot_visible_only_mut().set_val(true);
        graphic_frame.get_graphic_mut().get_graphic_data_mut().get_chart_space_mut().get_chart_mut().get_display_blanks_as_mut().set_val(DisplayBlanksAsValues::Zero);
        graphic_frame.get_graphic_mut().get_graphic_data_mut().get_chart_space_mut().get_print_settings_mut().get_page_margins_mut().set_bottom(0.75);
        graphic_frame.get_graphic_mut().get_graphic_data_mut().get_chart_space_mut().get_print_settings_mut().get_page_margins_mut().set_left(0.7);
        graphic_frame.get_graphic_mut().get_graphic_data_mut().get_chart_space_mut().get_print_settings_mut().get_page_margins_mut().set_right(0.7);
        graphic_frame.get_graphic_mut().get_graphic_data_mut().get_chart_space_mut().get_print_settings_mut().get_page_margins_mut().set_top(0.75);
        graphic_frame.get_graphic_mut().get_graphic_data_mut().get_chart_space_mut().get_print_settings_mut().get_page_margins_mut().set_header(0.3);
        graphic_frame.get_graphic_mut().get_graphic_data_mut().get_chart_space_mut().get_print_settings_mut().get_page_margins_mut().set_footer(0.3);
        self.two_cell_anchor.set_graphic_frame(graphic_frame);
    }

    pub(crate) fn new_chart_line_3d_chart(
        &mut self, 
        area_chart_series_list: Vec<&str>,
    ) {
        ...
        let mut graphic_frame = GraphicFrame::default();
        graphic_frame.get_graphic_mut().get_graphic_data_mut().get_chart_space_mut().get_editing_language_mut().set_val(&self.default_language);
        graphic_frame.get_graphic_mut().get_graphic_data_mut().get_chart_space_mut().get_chart_mut().set_view_3d(view_3d);
        graphic_frame.get_graphic_mut().get_graphic_data_mut().get_chart_space_mut().get_chart_mut().get_plot_area_mut().set_line_3d_chart(line_3d_chart);
        graphic_frame.get_graphic_mut().get_graphic_data_mut().get_chart_space_mut().get_chart_mut().get_plot_area_mut().add_category_axis(category_axis);
        graphic_frame.get_graphic_mut().get_graphic_data_mut().get_chart_space_mut().get_chart_mut().get_plot_area_mut().add_value_axis(value_axis);
        graphic_frame.get_graphic_mut().get_graphic_data_mut().get_chart_space_mut().get_chart_mut().get_legend_mut().get_legend_position_mut().set_val(LegendPositionValues::Right);
        graphic_frame.get_graphic_mut().get_graphic_data_mut().get_chart_space_mut().get_chart_mut().get_legend_mut().set_layout(layout);
    ...
    pub(crate) fn new_chart_pie_chart(
        &mut self, 
        area_chart_series_list: Vec<&str>,
    ) {
        let mut acsl_obj = AreaChartSeriesList::default();
        ...
        let mut graphic_frame = GraphicFrame::default();
        graphic_frame.get_graphic_mut().get_graphic_data_mut().get_chart_space_mut().get_editing_language_mut().set_val(&self.default_language);
        graphic_frame.get_graphic_mut().get_graphic_data_mut().get_chart_space_mut().get_chart_mut().get_plot_area_mut().set_pie_chart(pie_chart);
        graphic_frame.get_graphic_mut().get_graphic_data_mut().get_chart_space_mut().get_chart_mut().get_legend_mut().get_legend_position_mut().set_val(LegendPositionValues::Right);
        graphic_frame.get_graphic_mut().get_graphic_data_mut().get_chart_space_mut().get_chart_mut().get_legend_mut().set_layout(layout);
        graphic_frame.get_graphic_mut().get_graphic_data_mut().get_chart_space_mut().get_chart_mut().get_legend_mut().set_text_properties(text_properties);
        graphic_frame.get_graphic_mut().get_graphic_data_mut().get_chart_space_mut().get_chart_mut().get_plot_visible_only_mut().set_val(true);
        graphic_frame.get_graphic_mut().get_graphic_data_mut().get_chart_space_mut().get_chart_mut().get_display_blanks_as_mut().set_val(DisplayBlanksAsValues::Gap);
        graphic_frame.get_graphic_mut().get_graphic_data_mut().get_chart_space_mut().get_print_settings_mut().get_page_margins_mut().set_bottom(0.75);
        graphic_frame.get_graphic_mut().get_graphic_data_mut().get_chart_space_mut().get_print_settings_mut().get_page_margins_mut().set_left(0.7);
        graphic_frame.get_graphic_mut().get_graphic_data_mut().get_chart_space_mut().get_print_settings_mut().get_page_margins_mut().set_right(0.7);
        graphic_frame.get_graphic_mut().get_graphic_data_mut().get_chart_space_mut().get_print_settings_mut().get_page_margins_mut().set_top(0.75);
    ...
    pub(crate) fn new_chart_pie_3d_chart(
        &mut self, 
        area_chart_series_list: Vec<&str>,
    ) {
        let mut rotate_x = RotateX::default();
        ...
        graphic_frame.get_graphic_mut().get_graphic_data_mut().get_chart_space_mut().get_editing_language_mut().set_val(&self.default_language);
        graphic_frame.get_graphic_mut().get_graphic_data_mut().get_chart_space_mut().get_chart_mut().set_view_3d(view_3d);
        graphic_frame.get_graphic_mut().get_graphic_data_mut().get_chart_space_mut().get_chart_mut().get_plot_area_mut().set_pie_3d_chart(pie_3d_chart);
        graphic_frame.get_graphic_mut().get_graphic_data_mut().get_chart_space_mut().get_chart_mut().get_legend_mut().get_legend_position_mut().set_val(LegendPositionValues::Right);
        graphic_frame.get_graphic_mut().get_graphic_data_mut().get_chart_space_mut().get_chart_mut().get_legend_mut().set_layout(layout);
        graphic_frame.get_graphic_mut().get_graphic_data_mut().get_chart_space_mut().get_chart_mut().get_legend_mut().set_text_properties(text_properties);
        graphic_frame.get_graphic_mut().get_graphic_data_mut().get_chart_space_mut().get_chart_mut().get_plot_visible_only_mut().set_val(true);
    ...
    pub(crate) fn new_chart_doughnut_chart(
        &mut self, 
        area_chart_series_list: Vec<&str>,
    ) {
        let mut acsl_obj = AreaChartSeriesList::default();
        ...
        for area_chart_series in area_chart_series_list {
            if ptn == 0 {
                ...
                category_axis_data.get_string_reference_mut().get_formula_mut().get_address_mut().set_address(area_chart_series);
        ...
        let mut graphic_frame = GraphicFrame::default();
        graphic_frame.get_graphic_mut().get_graphic_data_mut().get_chart_space_mut().get_editing_language_mut().set_val(&self.default_language);
        graphic_frame.get_graphic_mut().get_graphic_data_mut().get_chart_space_mut().get_chart_mut().get_plot_area_mut().set_doughnut_chart(doughnut_chart);
        graphic_frame.get_graphic_mut().get_graphic_data_mut().get_chart_space_mut().get_chart_mut().get_legend_mut().get_legend_position_mut().set_val(LegendPositionValues::Right);
        graphic_frame.get_graphic_mut().get_graphic_data_mut().get_chart_space_mut().get_chart_mut().get_legend_mut().set_layout(layout);
        graphic_frame.get_graphic_mut().get_graphic_data_mut().get_chart_space_mut().get_chart_mut().get_plot_visible_only_mut().set_val(true);
        graphic_frame.get_graphic_mut().get_graphic_data_mut().get_chart_space_mut().get_chart_mut().get_display_blanks_as_mut().set_val(DisplayBlanksAsValues::Gap);
    ...
    pub(crate) fn new_chart_area_chart(
        &mut self, 
        area_chart_series_list: Vec<&str>,
    ) {
        let mut acsl_obj = AreaChartSeriesList::default();
        ...
        let mut graphic_frame = GraphicFrame::default();
        graphic_frame.get_graphic_mut().get_graphic_data_mut().get_chart_space_mut().get_editing_language_mut().set_val(&self.default_language);
        graphic_frame.get_graphic_mut().get_graphic_data_mut().get_chart_space_mut().get_chart_mut().get_plot_area_mut().set_area_chart(area_chart);
        graphic_frame.get_graphic_mut().get_graphic_data_mut().get_chart_space_mut().get_chart_mut().get_plot_area_mut().add_category_axis(category_axis);
        graphic_frame.get_graphic_mut().get_graphic_data_mut().get_chart_space_mut().get_chart_mut().get_plot_area_mut().add_value_axis(value_axis);
        graphic_frame.get_graphic_mut().get_graphic_data_mut().get_chart_space_mut().get_chart_mut().get_legend_mut().get_legend_position_mut().set_val(LegendPositionValues::Right);
        graphic_frame.get_graphic_mut().get_graphic_data_mut().get_chart_space_mut().get_chart_mut().get_plot_visible_only_mut().set_val(true);
    ...
    pub(crate) fn new_chart_area_3d_chart(
        &mut self, 
        area_chart_series_list: Vec<&str>,
    ) {
        let mut rotate_x = RotateX::default();
        ...
        graphic_frame.get_graphic_mut().get_graphic_data_mut().get_chart_space_mut().get_editing_language_mut().set_val(&self.default_language);
        graphic_frame.get_graphic_mut().get_graphic_data_mut().get_chart_space_mut().get_chart_mut().set_view_3d(view_3d);
        graphic_frame.get_graphic_mut().get_graphic_data_mut().get_chart_space_mut().get_chart_mut().get_plot_area_mut().set_area_3d_chart(area_3d_chart);
        graphic_frame.get_graphic_mut().get_graphic_data_mut().get_chart_space_mut().get_chart_mut().get_plot_area_mut().add_category_axis(category_axis);
        graphic_frame.get_graphic_mut().get_graphic_data_mut().get_chart_space_mut().get_chart_mut().get_plot_area_mut().add_value_axis(value_axis);
        graphic_frame.get_graphic_mut().get_graphic_data_mut().get_chart_space_mut().get_chart_mut().get_legend_mut().get_legend_position_mut().set_val(LegendPositionValues::Right);
        graphic_frame.get_graphic_mut().get_graphic_data_mut().get_chart_space_mut().get_chart_mut().get_plot_visible_only_mut().set_val(true);
    ...
    pub(crate) fn new_chart_bar_chart(
        &mut self, 
        area_chart_series_list: Vec<&str>,
    ) {
        let mut acsl_obj = AreaChartSeriesList::default();
        ...
        let mut graphic_frame = GraphicFrame::default();
        graphic_frame.get_graphic_mut().get_graphic_data_mut().get_chart_space_mut().get_editing_language_mut().set_val(&self.default_language);
        graphic_frame.get_graphic_mut().get_graphic_data_mut().get_chart_space_mut().get_chart_mut().get_plot_area_mut().set_bar_chart(bar_chart);
        graphic_frame.get_graphic_mut().get_graphic_data_mut().get_chart_space_mut().get_chart_mut().get_plot_area_mut().add_category_axis(category_axis);
        graphic_frame.get_graphic_mut().get_graphic_data_mut().get_chart_space_mut().get_chart_mut().get_plot_area_mut().add_value_axis(value_axis);
        graphic_frame.get_graphic_mut().get_graphic_data_mut().get_chart_space_mut().get_chart_mut().get_legend_mut().get_legend_position_mut().set_val(LegendPositionValues::Right);
        graphic_frame.get_graphic_mut().get_graphic_data_mut().get_chart_space_mut().get_chart_mut().get_plot_visible_only_mut().set_val(true);
    ...
    pub(crate) fn new_chart_bar_3d_chart(
        &mut self, 
        area_chart_series_list: Vec<&str>,
    ) {
        let mut rotate_x = RotateX::default();
        ...
        graphic_frame.get_graphic_mut().get_graphic_data_mut().get_chart_space_mut().get_editing_language_mut().set_val(&self.default_language);
        graphic_frame.get_graphic_mut().get_graphic_data_mut().get_chart_space_mut().get_chart_mut().set_view_3d(view_3d);
        graphic_frame.get_graphic_mut().get_graphic_data_mut().get_chart_space_mut().get_chart_mut().get_plot_area_mut().set_bar_3d_chart(bar_3d_chart);
        graphic_frame.get_graphic_mut().get_graphic_data_mut().get_chart_space_mut().get_chart_mut().get_plot_area_mut().add_category_axis(category_axis);
        graphic_frame.get_graphic_mut().get_graphic_data_mut().get_chart_space_mut().get_chart_mut().get_plot_area_mut().add_value_axis(value_axis);
        graphic_frame.get_graphic_mut().get_graphic_data_mut().get_chart_space_mut().get_chart_mut().get_legend_mut().get_legend_position_mut().set_val(LegendPositionValues::Right);
        graphic_frame.get_graphic_mut().get_graphic_data_mut().get_chart_space_mut().get_chart_mut().get_plot_visible_only_mut().set_val(true);
    ...
    pub(crate) fn new_chart_of_pie_chart(
        &mut self, 
        area_chart_series_list: Vec<&str>,
    ) {
        let mut acsl_obj = AreaChartSeriesList::default();
        ...
        let mut graphic_frame = GraphicFrame::default();
        graphic_frame.get_graphic_mut().get_graphic_data_mut().get_chart_space_mut().get_editing_language_mut().set_val(&self.default_language);
        graphic_frame.get_graphic_mut().get_graphic_data_mut().get_chart_space_mut().get_chart_mut().get_plot_area_mut().set_of_pie_chart(of_pie_chart);
        graphic_frame.get_graphic_mut().get_graphic_data_mut().get_chart_space_mut().get_chart_mut().get_legend_mut().get_legend_position_mut().set_val(LegendPositionValues::Right);
        graphic_frame.get_graphic_mut().get_graphic_data_mut().get_chart_space_mut().get_chart_mut().get_legend_mut().set_text_properties(text_properties);
        graphic_frame.get_graphic_mut().get_graphic_data_mut().get_chart_space_mut().get_chart_mut().get_plot_visible_only_mut().set_val(true);
        graphic_frame.get_graphic_mut().get_graphic_data_mut().get_chart_space_mut().get_chart_mut().get_display_blanks_as_mut().set_val(DisplayBlanksAsValues::Gap);
    ...
    pub(crate) fn new_chart_bubble_chart(
        &mut self, 
        area_chart_series_list: Vec<&str>,
    ) {
        let mut acsl_obj = AreaChartSeriesList::default();
        ...
        for area_chart_series in area_chart_series_list {
            if ptn == 0 {
                ...
                x_values.get_number_reference_mut().get_formula_mut().get_address_mut().set_address(area_chart_series);
                x_values.get_number_reference_mut().get_numbering_cache_mut().get_format_code_mut().set_text("General");
                acs_obj.set_x_values(x_values);
                
                ptn += 1;
            } else if ptn == 1 {
                let mut y_values = YValues::default();
                y_values.get_number_reference_mut().get_formula_mut().get_address_mut().set_address(area_chart_series);
                y_values.get_number_reference_mut().get_numbering_cache_mut().get_format_code_mut().set_text("General");
                acs_obj.set_y_values(y_values);

                ptn += 1;
            } else if ptn == 2 {
                let mut bubble_size = BubbleSize::default();
                bubble_size.get_number_reference_mut().get_formula_mut().get_address_mut().set_address(area_chart_series);
                bubble_size.get_number_reference_mut().get_numbering_cache_mut().get_format_code_mut().set_text("General");
        ...
        let mut graphic_frame = GraphicFrame::default();
        graphic_frame.get_graphic_mut().get_graphic_data_mut().get_chart_space_mut().get_editing_language_mut().set_val(&self.default_language);
        graphic_frame.get_graphic_mut().get_graphic_data_mut().get_chart_space_mut().get_chart_mut().get_plot_area_mut().set_bubble_chart(bubble_chart);
        graphic_frame.get_graphic_mut().get_graphic_data_mut().get_chart_space_mut().get_chart_mut().get_plot_area_mut().add_value_axis(value_axis_1);
        graphic_frame.get_graphic_mut().get_graphic_data_mut().get_chart_space_mut().get_chart_mut().get_plot_area_mut().add_value_axis(value_axis_2);
        graphic_frame.get_graphic_mut().get_graphic_data_mut().get_chart_space_mut().get_chart_mut().get_legend_mut().get_legend_position_mut().set_val(LegendPositionValues::Right);
        graphic_frame.get_graphic_mut().get_graphic_data_mut().get_chart_space_mut().get_chart_mut().get_legend_mut().set_text_properties(text_properties);
        graphic_frame.get_graphic_mut().get_graphic_data_mut().get_chart_space_mut().get_chart_mut().get_plot_visible_only_mut().set_val(true);
        graphic_frame.get_graphic_mut().get_graphic_data_mut().get_chart_space_mut().get_chart_mut().get_display_blanks_as_mut().set_val(DisplayBlanksAsValues::Gap);
    ...
    pub(crate) fn new_chart_radar_chart(
        &mut self, 
        area_chart_series_list: Vec<&str>,
    ) {
        let mut acsl_obj = AreaChartSeriesList::default();
        ...
        let mut graphic_frame = GraphicFrame::default();
        graphic_frame.get_graphic_mut().get_graphic_data_mut().get_chart_space_mut().get_editing_language_mut().set_val(&self.default_language);
        graphic_frame.get_graphic_mut().get_graphic_data_mut().get_chart_space_mut().get_chart_mut().get_plot_area_mut().set_radar_chart(radar_chart);
        graphic_frame.get_graphic_mut().get_graphic_data_mut().get_chart_space_mut().get_chart_mut().get_plot_area_mut().add_category_axis(category_axis);
        graphic_frame.get_graphic_mut().get_graphic_data_mut().get_chart_space_mut().get_chart_mut().get_plot_area_mut().add_value_axis(value_axis);
        graphic_frame.get_graphic_mut().get_graphic_data_mut().get_chart_space_mut().get_chart_mut().get_legend_mut().get_legend_position_mut().set_val(LegendPositionValues::Right);
        graphic_frame.get_graphic_mut().get_graphic_data_mut().get_chart_space_mut().get_chart_mut().get_legend_mut().set_layout(layout);
    ...
    pub(crate) fn new_chart_scatter_chart(
        &mut self, 
        area_chart_series_list: Vec<&str>,
    ) {
        let mut acsl_obj = AreaChartSeriesList::default();
        ...
        let mut graphic_frame = GraphicFrame::default();
        graphic_frame.get_graphic_mut().get_graphic_data_mut().get_chart_space_mut().get_editing_language_mut().set_val(&self.default_language);
        graphic_frame.get_graphic_mut().get_graphic_data_mut().get_chart_space_mut().get_chart_mut().get_plot_area_mut().set_scatter_chart(scatter_chart);
        graphic_frame.get_graphic_mut().get_graphic_data_mut().get_chart_space_mut().get_chart_mut().get_plot_area_mut().add_value_axis(value_axis_1);
        graphic_frame.get_graphic_mut().get_graphic_data_mut().get_chart_space_mut().get_chart_mut().get_plot_area_mut().add_value_axis(value_axis_2);
        graphic_frame.get_graphic_mut().get_graphic_data_mut().get_chart_space_mut().get_chart_mut().get_legend_mut().get_legend_position_mut().set_val(LegendPositionValues::Right);
        graphic_frame.get_graphic_mut().get_graphic_data_mut().get_chart_space_mut().get_chart_mut().get_legend_mut().set_layout(layout);
